...
export const defaultSealConfig: SealConfig = {
  ...
  layers: [
    ...
    { id: layerIds.bottom, kind: "arcText", visible: true, locked: false, zIndex: 12, content: "91310101XXXXXXXXXX", fontId: "system-sans", fontSize: 38, letterSpacing: 4, scaleX: 1, scaleY: 1, rotation: 0, offsetX: 0, offsetY: 155, radiusX: 260, radiusY: 260, startAngle: 0, sweepAngle: -180 },
